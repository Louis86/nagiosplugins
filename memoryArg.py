...
parser.add_argument('-wMaw',"warningMax" ,help="Maximum of memory : state warning", type=int)
parser.add_argument('-cMin',"criticalMin" ,help="Minimum of memory :  stage critical", type=int)
